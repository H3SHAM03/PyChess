...
def drawBoard():
    ...
    for i in range(8):
        for j in range(8):
            ...
            squares[i].append(sq)
        color += 1
        board.blit(get_font(20).render(str(8-i),True,"#ffffff"),(80,(squares[i][0].pos[1]+squares[0][0].height/2)-12))
        board.blit(get_font(20).render(str(8-i),True,"#ffffff"),(710,(squares[i][0].pos[1]+squares[0][0].height/2)-12))
...
def drawPossibleMoves(piece):
    ...
    for i in possible:
        center = (squares[i[0]-1][i[1]-1].pos[0] + squares[0][0].width/2, squares[8-i[0]][8-i[1]].pos[1] + squares[0][0].height/2)
...
[]]
for i in range(8):
    blackPieces[1].append(piece("pawn","black","assets\\black-pawn.png",(7,i+1)))
...
for i in range(8):
    whitePieces[0].append(piece("pawn","white","assets\\white-pawn.png",(2,i+1)))
captures_pieces = []
for i in range (8):
    squares.append([])
drawBoard()
